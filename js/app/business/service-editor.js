...
import './service-editor.scss'

const childrenContainer = document.querySelector('#service_editor_children')
...
const sectionContainers = [].slice.call(document.querySelectorAll('.serviceEditor__left'))
...
function reorderSections() {
    ...
    const sectionPositions = [].slice.call(document.querySelectorAll('.serviceEditor__left .serviceEditor__panel')).map((el, index) => {
        return {
