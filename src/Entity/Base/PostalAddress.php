...
abstract class PostalAddress
{
     ...
     *
     * @Groups({"address_create","listing_public"})
     ...
     *
     * @Groups({"address", "address_create", "listing_public"})
     * @Assert\Type(type="string")
     ...
     *
     * @Groups({"address", "address_create", "listing_create", "listing_edit",  "listing_public"})
     * @Assert\Type(type="string")
     * @Assert\NotBlank()
