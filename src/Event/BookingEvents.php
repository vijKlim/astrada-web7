...
class BookingEvents
{
     ...
     */
    const BOOKING_INIT = 'astrada.booking_new.init';
     ...
     * The event listener method receives a Cocorico\CoreBundle\Event\BookingEvent instance.
     */
    const BOOKING_NEW_SUBMITTED = 'astrada.booking_new.submitted';
     ...
     * The event listener method receives a Cocorico\CoreBundle\Event\BookingEvent instance.
     */
    const BOOKING_NEW_CREATED = 'astrada.booking_new.created';
     ...
     * The event listener method receives a Cocorico\CoreBundle\Event\BookingEvent instance.
     */
    const BOOKING_PAY = 'astrada.booking.pay';
     ...
     */
    const BOOKING_REFUND = 'astrada.booking.refund';
     ...
     */
    const BOOKING_VALIDATE = 'astrada.booking.validate';
     ...
     * The event listener method receives a Cocorico\CoreBundle\Event\BookingValidateEvent instance.
     */
    const BOOKING_POST_VALIDATE = 'astrada.booking.post_validate';
}