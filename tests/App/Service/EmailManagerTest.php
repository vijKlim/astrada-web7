...
class EmailManagerTest extends TestCase
{
    ...
    public function testCreateHtmlMessage()
    {
        ...
        $this->assertEquals('"Acme" <transactional@aquastrada.com>', $from[0]->toString());
        $this->assertEquals('"Acme" <transactional@aquastrada.com>', $sender->toString());
    ...
    public function testMessageIsNotSentToDemoUser()
    {
        ...
        $message->addTo('joe@demo.aquastrada.com');
        $this->emailManager->send($message);

        $message->addTo('Joe <joe@demo.aquastrada.com>');
        $this->emailManager->send($message);
    }
